...
const steps = [
  {
    ...
    description: "Our insider network monitors journalist requests from publications that don't accept paid placements",
  },
  {
    icon: Target,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl lg:text-5xl font-bold text-center mb-6 text-balance text-gray-900">
            How We Secure <span className="text-purple-600">Impossible-to-Buy</span> Editorial Placements
          </h2>
