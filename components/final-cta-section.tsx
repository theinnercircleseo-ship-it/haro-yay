          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            <Link href="/contact">
              <Button
                variant="outline"
                size="lg"
                className="text-lg px-8 py-6 border-2 hover:bg-gray-100 hover:text-gray-900 hover:border-gray-100 font-semibold w-full sm:w-auto cursor-pointer text-gray-900 border-gray-300 bg-white"
              >
