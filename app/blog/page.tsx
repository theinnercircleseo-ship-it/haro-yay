          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 max-w-2xl mx-auto">
                ...
                <button className="flex items-center gap-2 px-6 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
